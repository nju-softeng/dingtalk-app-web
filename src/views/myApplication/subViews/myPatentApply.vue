      ...
      <div class="list" style="height: 500px">
        <el-table :data="list" class="tableClass">
          ...
          <el-table-column label="状态" align="center" width="110">
            <template slot="header" slot-scope="scope">
              <el-dropdown @command="filterTag">
                <span class="el-dropdown-link">
                  申请状态<i class="el-icon-arrow-down el-icon--right"></i>
                </span>
            ...
            <template slot-scope="scope">
              <div class="info-item">
                <el-tag v-if="scope.row.state === 0" class="patent-tag"
                  >待内审</el-tag
                >
                <el-tag
                ...
                <el-tag
                  ...
                  >专利驳回</el-tag
                >
                <el-tag v-else class="patent-tag" type="danger"
    ...
    >
      ...
      <div v-loading="loading">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button type="primary" @click="submit('patentForm')"
            >确 定</el-button
          >
