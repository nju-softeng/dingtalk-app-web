    ...
    <div class="reimburseDetailWrap">
      ...
      <el-card shadow="hover" class="bodyCard">
        <div class="fileHead">
          <div>报销文件</div>
          <el-button
            v-show="reimburseInfo.state === -1 || reimburseInfo.state === 2"
            type="primary"
          ...
          <div v-if="fileList.length !== 0">
            ...
            >
              <div class="hoverButtons">
                ...
                <el-button
                  class="hoverBtn downloadBtn"
                  icon="el-icon-download"
                  @click="downloadFile(file)"
                />
                <el-button
                  class="hoverBtn deleteBtn"
                  icon="el-icon-delete"
  ...
  methods: {
    ...
    async getMoreFile() {
      ...
      for (
        ...
        i < this.reimburseInfo.reimbursementFileList.length;
        i++
      ) {
        await downloadReimbursementFile(
